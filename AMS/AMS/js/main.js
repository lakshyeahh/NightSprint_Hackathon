  ...
  if (list.length === 0) {
    ...
    const element = String.raw`
			<div class="ui icon warning message">
				...
				<div class="content">
					<div class="header">You have no articles!</div>
					<div>Enter Articles above.</div>
				</div>
			</div>
		`
...
function addTask(event) {
  ...
  showNotification("success", "Article was successfully added")
  showTasksList()
}
...
function removeTask(id) {
  ...
  showNotification("error", "Article was successfully deleted")
  showTasksList()
}
